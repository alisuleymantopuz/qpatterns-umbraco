...
{
    public class ReadOnlyCachedRepository<T> : IReadOnlyRepository<T> where T : class
    {
        ...
        public ReadOnlyCachedRepository(TimeSpan refreshInterval, IReadOnlyRepository<T> readOnlyRepositoryToCache)
        {
